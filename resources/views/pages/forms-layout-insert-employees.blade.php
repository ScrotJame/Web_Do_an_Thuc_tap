            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="card">
                    ...
                    <div class="p-4 sm:p-5">
                        <form action="{{ route('forms/layout-insert-employees') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <label class="block">
                                        ...
                                        <input
                                            ...
                                            placeholder="Enter ID" type="text" name="id_nhanvien" />
                                    </label>
                                    ...
                                    <label class="block">
                                        ...
                                        <input
                                            class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2"
                                            placeholder="Enter full name" type="text" name="hoten" />
                                    </label>
                                    ...
                                    <label class="block">
                                        ...
                                        <input
                                            class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2"
                                            placeholder="Enter birthdate" type="date" name="ngaysinh" />
                                    </label>
                                    ...
                                    <label class="block">
                                        ...
                                        <select
                                            ...
                                            @foreach($positions as $position)
                                                <option value="{{ $position->id_chucvu }}">{{ $position->tenchucvu }}</option>
                                            @endforeach
                                        </select>
                                    </label>
                                    ...
                                    <label class="block">
                                        ...
                                        <input
                                            class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2"
                                            placeholder="Enter join date" type="date" name="ngayvaolam" />
                                    </label>
                                    ...
                                    <label class="block">
                                        ...
                                        <select
                                            class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2"
                                            name="id_hinhthuchopdong">
                                            <option value="" selected>-- Lựa chọn --</option>
                                            @foreach($contractTypes as $contractType)
                                                <option value="{{ $contractType->id_hinhthuchopdong }}">{{ $contractType->tenhinhthuc }}</option>
                                            @endforeach
                                        </select>
                                    </label>
                                    ...
                                    <label class="block">
                                        ...
                                        <input
                                            class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2"
                                            placeholder="Enter phone number" type="text" name="sodienthoai" />
                                    </label>
                                    ...
                                    <label class="block">
                                        ...
                                        <input
                                            class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2"
                                            placeholder="Enter address" type="text" name="diachi" />
                                    </label>
