                        ...
                        <table x-ref="table" class="w-full text-left">
                            ...
                            <tbody>
                                @foreach ($positions as $position)
                                    <tr>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ $position->id }}</td>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ $position->name }}</td>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ $position->description }}</td>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <a href="{{ route('positions.edit', $position->id) }}" class="text-blue-500">Sửa</a> |
